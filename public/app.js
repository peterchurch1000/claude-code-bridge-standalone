...
(function () {
  ...
  function vncSrcFor(room) {
    if (_RV) return `${API_BASE}/room-view-client.html?v=10&room=` + encodeURIComponent(room || 'default');
