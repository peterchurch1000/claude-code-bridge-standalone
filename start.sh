...
export MCP_PORT="${MCP_PORT:-8951}"
export CDP_PORT="${CDP_PORT:-9231}"
export BRIDGE_PORT="${BRIDGE_PORT:-3467}"
export AUTH_PORT="${AUTH_PORT:-3468}"
export NOVNC_URL="${NOVNC_URL:-https://claude-bridge-standalone.procyss-automation.com/vnc}"
export CHROME_PROFILE_DIR="${CHROME_PROFILE_DIR:-/root/.config/chromium-mcp-profile}"
export CLAUDE_CWD="${CLAUDE_CWD:-/var/www/html/claude-code-bridge-standalone}"
